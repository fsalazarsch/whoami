...
class NetworkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create networking" do
    assert_difference("Networking.count") do
      post networkings_url, params: { networking: { profile: @networking.profile, url: @networking.url } }
    end
  ...
  test "should update networking" do
    patch networking_url(@networking), params: { networking: { profile: @networking.profile, url: @networking.url } }
