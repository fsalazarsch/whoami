...
class AddonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create addon" do
    assert_difference("Addon.count") do
      post addons_url, params: { addon: { category: @addon.category, key_value: @addon.key_value, percent: @addon.percent, value: @addon.value } }
    end
  ...
  test "should update addon" do
    patch addon_url(@addon), params: { addon: { category: @addon.category, key_value: @addon.key_value, percent: @addon.percent, value: @addon.value } }
